...
def get_items_with_min_support(item_set, all_transactions, min_support,
    ...
    # START YOUR CODE HERE  #
    #========================#
    ## hint: scan local_set and add valid candidates to rtn
    for key,val in local_set.items():
        if (val >= min_support):
            rtn.add(key)
    #========================#
    #   END YOUR CODE HERE   #
...
def run_apriori_loops(one_cand_set, set_count_map, all_transactions,
    ...
    # START YOUR CODE HERE  #
    #========================#
    ## hint, you will need to use join_set() and get_items_with_min_support() functions here
        ...
        for item in value:
            ...
            for element in _subsets:
                ...
                if len(remain) > 0:
                    ...
                    # START YOUR CODE HERE  #
                    #========================#
                    ## hint: you will need to use get_support() function here
                    confidence = 0
                    #========================#
                    #   END YOUR CODE HERE   #
                    #========================# 
...
def join_set(s, l):
    ...
    # START YOUR CODE HERE  #
    #========================#
    ## s is the current set, l is the current level (same as length k)
    ## hint: you may use set1.union(set2) to combine two sets
    join_set =  set()
